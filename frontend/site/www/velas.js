...
const SantuarioVelas = {
    ...
    verIntencao(index) {
        ...
        modal.innerHTML = `
            <div class="bg-gradient-to-br from-gray-900 via-purple-900/30 to-gray-900 rounded-3xl w-full max-w-sm p-6">
                ...
                <button onclick="SantuarioVelas.reportarVela(${index})" class="w-full py-2 text-white/40 text-xs hover:text-white/60 transition-all">
                    Reportar conteúdo
                </button>
            </div>
        `;
        ...
        modal.innerHTML = `
            <div class="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-5 max-w-sm w-full">
                ...
                <div class="flex gap-3">
                    ...
                    <button onclick="SantuarioVelas.enviarReportVela(${index})" class="flex-1 py-3 bg-red-600 text-white rounded-xl font-semibold hover:bg-red-500 transition-all">
                        Reportar
                    </button>
                </div>
            </div>
    ...
    // Enviar denúncia de vela para o servidor
    async enviarReportVela(index) {
        const vela = this.velasAcesas[index];
